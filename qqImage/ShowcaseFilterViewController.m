...
@synthesize checkedIndexArray,arrayTemp;
...
- (void)viewDidLoad
{
    ...
    UIButton *backBtn= [TKGlobal getButton:@"button_back_normal" highlightName:@"button_back_pressed" target:self selector:@selector(onBack)];
    backBtn.center = CGPointMake(30, 30);
